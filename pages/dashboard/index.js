...
export default function Dashboard({ products }) {
  ...
  return (
    <div>
      ...
      <h1 className='flex justify-center mt-20 text-xl'>Dashboard for {session.user.name}</h1>
      ...
      <div className='flex justify-center mt-10'>
        <div className='flex flex-col w-full'>
          { products && products.map(product => (
            ...
            >
              {product.image && (
                <img src={product.image} alt={product.title} className='w-14 h-14 flex-initial' />
              )}
